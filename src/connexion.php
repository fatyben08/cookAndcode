        ...
        <div class="container">
            ...
            <div class="left-box">
                ...
                <form method="POST">
                    ...
                    <input type="text" id="username" name="pseudo" placeholder="Identifiant">
            ...
            <div class="right-box">
                ...
                <div class="list">
                    <div class="icon"><img src="./assets/img/Toque-Chef-Hat-PNG-Image.png" alt="toque">
                        <p> Gérez vos favorites</p>
                    </div>
                    <div class="icon"><img src="./assets/img/Toque-Chef-Hat-PNG-Image.png" alt="toque">
                        <p>Recevez nos nouveautés</p>
                    </div>
                    <div class="icon"><img src="./assets/img/Toque-Chef-Hat-PNG-Image.png" alt="toque">
                        <p>Partager votre avis</p>
                    </div>
                </div>

                <a href="./inscription.php"><button name="type" value="creation">Je crée mon compte</button></a>
            </div>
        </div>
    </main>
